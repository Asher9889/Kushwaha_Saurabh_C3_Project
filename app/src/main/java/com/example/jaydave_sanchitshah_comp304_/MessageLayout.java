...
public class MessageLayout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*AlertDialog.Builder builder=new AlertDialog.Builder(MessageLayout.this);
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent=new Intent(MessageLayout.this,MapsActivity.class);
                startActivity(intent);
            }
        });
        ...
        String vicinity=sharedpreferences.getString("vicinity","");
